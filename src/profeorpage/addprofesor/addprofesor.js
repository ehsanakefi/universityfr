                ...
                {this.state.showMenu ? (
                  ...
                  >
                    <div className="menulogout">
                      {" "}
                      <img className="imgmenulogout" src={LogOut} alt="notFound" /> <div className="textlogout">خروج</div>
                    </div>
                  </div>
                ) : null}
              </div>
          ...
          <div className="dashbord_icons">
            ...
            <div className="dashbord_icons_box">
              <div className="dashbord_icons_box_into">
                <div className="dashbord_icons_box_img">
                  <img className="dashbord_icons_box_selected_img_icon" src={professorimg} alt="notFound" />
                </div>
                <div className="dashbord_icons_box_text">
                  <p className="dashbord_icons_box_text_icon">تنظیمات اولیه دانشگاه </p>
                </div>
              </div>
            </div>
            <div className="dashbord_icons_box">
              <div className="dashbord_icons_box_into">
                ...
                <div className="dashbord_icons_box_text">
                  <p className="dashbord_icons_box_text_icon">اضافه کردن استاد</p>
                </div>
              </div>
            </div>
            <div className="dashbord_icons_box">
          ...
          <div className="profesorsadd_search">
            <div className="profesorsadd_search_box">
              ...
              <div className="profesorsadd_search_box_text">
                <input className="profesorsadd_search_box_text_input" type="text" />{" "}
              </div>
            </div>
          </div>
          ...
          <div className="details_up">
            <div className="details_up_threebox">
              <div className="details_up_threebox_img">
                <img className="details_up_threebox_img_icon" src={Clocktime} alt="Notfound" />
              </div>
            ...
            <div className="details_up_threebox">
              <div className="details_up_threebox_img">
                <img className="details_up_threebox_img_icon" src={Booksthree} alt="Notfound" />
              </div>
            ...
            <div className="details_up_threebox">
              <div className="details_up_threebox_img">
                <img className="details_up_threebox_img_icon" src={Calendar} alt="Notfound" />
              </div>
